#!/usr/bin/env sh
# Universal installer for synthcohort. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/synthcohort.git"
echo "Installing synthcohort ..."
...
echo "Done. Run: synthcohort --help"
