...
- Niche focus: Spin up PHI-free test data that matches your real distributions in one command — lets teams demo and CI-test without ever touching real patients..
