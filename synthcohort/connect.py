"""Native cognis-connect emit for synthcohort — forward findings to any platform.

Maps synthcohort's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    synthcohort ... --format json | synthcohort-emit --to stix
    synthcohort-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
